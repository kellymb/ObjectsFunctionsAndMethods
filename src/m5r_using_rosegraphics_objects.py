...
#                attach_to, clone and attach_from
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center point, radius, and color
#
#     f. What does a RoseWindow RENDER method do?
#            draws the object on the window when it opens
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            the functions are carried out before the window opens so the if
#  not the windows would close instantly
#
