...
def turtle4():
    gohere =  rg.Point(random.randrange(-300, 300), random.randrange(-200, 200))
    joe = rg.SimpleTurtle('classic')
    joe.pen = rg.Pen('PaleTurquoise2', 25)
    joe.paint_bucket = rg.PaintBucket('PeachPuff4')

    joe.go_to(gohere)
    joe.backward(100)
    joe.begin_fill()
    joe.draw_regular_polygon(3,300)
    joe.end_fill()
